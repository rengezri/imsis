...
ims.View.plot_list([img, img2_1], ['Source', 'With black mask'], window_title='Add Mask')

img2_1 = ims.Image.Tools.add_blackborder(img, 25)
ims.View.plot_list([img, img2_1], ['Source', 'With black border'], window_title='Add Border')
...
ims.View.plot_list([img, img2_1, img2_2, img2_3], ['Source', 'Crop', 'Zoom', 'Bin'],
                   window_title='Image Crop, Zoom, Bin')
...
ims.View.plot_list([img, img2_1, img2_2, img2_3], ['Source with noise', 'Gaussianblur', 'Median', 'NonLocalMeans'],
                   window_title='Image Reduce Noise')
...
ims.View.plot_list([img, img2_1, img2_2], ['Source', 'Unsharpenmask', 'Deconv'], window_title='Image Sharpen')
...
ims.View.plot_list([img2_1, img2_2, img2_3], ['Canny edge auto', 'Gradientnonmaxsupp', 'Pencilsketch'],
                   window_title='Image Edge Enhancement')
...
ims.View.plot_list([img, im2_2], window_title='Image Morphological Filter')
...
ims.View.plot_list([img2_1, img2_2, img2_3, img2_4], ['Erode', 'Dilate', 'Open', 'Close'],
                   window_title='Image Morphological Filter')
...
ims.View.plot_list([img2_1, img2_2, img2_3], ['Threshold range', 'Threshold binary', 'Invert'],
                   window_title='Image Thresholding, Invert')
...
ims.View.plot_list_with_histogram([img, img2_1, img2_2], ['Source', 'Equalized Histogram', 'Clahe histogram'],
                                  window_title='Image Histogram Optimization')
...
ims.View.plot_list([img3_1, img1_1], ["Source", "Fisheye"], window_title='Image Fisheye')
...
ims.View.plot_list([grad, theta], ["Directional sharpness gradient", "Theta"],
                   window_title='Image Directional Sharpness')
...
ims.View.plot_list([img2_1, img2_2, img2_3], ['Source', 'Rotated', 'Image Registration of rotated image'],
                   window_title='Image Transformation, Rotation, Registration')

im_4 = ims.Image.Process.sepia(im_blueberry)
ims.View.plot_list([im_blueberry, im_4], ['Source', 'Sepia'], window_title="Sepia")
...
ims.View.plot_list([img, img2_1, img2_2], ['Source', 'FFT', 'IFFT'], window_title='Image FFT')
