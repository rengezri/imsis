...
ims.ImageStack.play(t, window_name="Align images")

fn = r".\output\alignmentdata.csv"
ims.Misc.save_multicolumnlist(fn, correctiondatalist,
                              ["X", "Y", "Score"])  # this one is used here, but testing the MISC class
...
ims.ImageStack.play(u, window_name="Reapply aligned Images")

s = ims.ImageStack.transition_fadeinout(img0, fadein=False)
ims.ImageStack.play(s, window_name="Fade out")
s = ims.ImageStack.reverse(s)
ims.ImageStack.play(s, window_name="Fade out reverse")
s = ims.ImageStack.transition_dissolve(img0, img1)
ims.ImageStack.play(s, window_name="Dissolve")
s = ims.ImageStack.transition_wipe(img0, img1, duration=2 * 15, reverse=False, horizontal=False)
ims.ImageStack.play(s, window_name="Wipe")
...
ims.ImageStack.play(s, window_name="Scroll")
